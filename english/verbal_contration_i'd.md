O uso das contrações ou abreviações são frequentes no inglês, tanto para respostas curtas (no, I don't) como para alguns verbos (To be, Verbos Auxiliares, Modals) **É para uso informal.**
